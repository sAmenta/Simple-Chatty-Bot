...
fun main() {
    greet("BotBot", "2020") // change it as you need
    remindName()
    guessAge()
    count()
    test()
...
fun count() {
    println("Now I will prove to you that I can bot.count to any number you want.")
...
fun test() {
    println("Let's bot.test your programming knowledge.")
